  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-emerald/95 backdrop-blur-md shadow-[0_8px_30px_-15px_rgba(0,0,0,0.6)]"
          : "bg-transparent"
      }`}
    >
      ...
      <div
        className={`overflow-hidden bg-emerald/98 backdrop-blur-md transition-[max-height] duration-500 md:hidden ${
